    ...
    const RELEASES = [
        {
            ...
            date: 'September 2026',
            items: [
                { t: 'UNITAR course reports use UNITAR\u2019s own upload template', d: 'The report is now their EMS workbook: their Participants sheet filled in, their Default Values sheet untouched, and a SURGhub summary added in front under the GSF logo. Their template requires each participant\u2019s surname, first name and email, so <strong>these files carry personal data</strong> \u2014 the app warns you before writing one, and the summary says so on its face. Send them to UNITAR only. Gender, nationality and organisation type are written as UNITAR\u2019s own codes, read from the template itself; where a learner stated nothing, their \u201cUnreported\u201d code is used so no required column is ever empty.' },
