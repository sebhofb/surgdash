  ...
  const ImpactShowcase = {
    ...
    _html(D) {
      ...
      const body =
        ...
        + (dials ? sec('impact', 'Impact', 'dark', '<h2 class="rv">Learning that changes practice.</h2><p class="lead rv d1" style="margin-bottom:8px">In post-course surveys, learners report applying what they have learned:</p><div class="dials">' + dials + '</div>' + (surveyN ? '<p class="muted rv d4" style="text-align:center;margin-top:26px">Based on ' + fmt(surveyN) + ' post-course survey responses.</p>' : '') + '<p class="lead rv" style="text-align:center;margin:30px auto 0">Learner stories</p>' + storyCards) : '')
