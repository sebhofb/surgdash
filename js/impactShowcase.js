  ...
  const ImpactShowcase = {
    ...
    _html(D) {
      ...
      function PAGE() {
        ...
        function drawGrowth() {
          var svg = document.getElementById('growth'); if (!svg || svg._done) return; svg._done = 1;
          var A = D.learnersSeries || [], B = D.certsSeries || []; if (!A.length) { svg.parentNode.style.display = 'none'; return; }
          var W = 820, H = 340, padL = 8, padR = 8, padT = 22, padB = 30, n = A.length;
