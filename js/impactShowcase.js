  ...
  const ImpactShowcase = {
    ...
    _html(D) {
      ...
      const geoScrolly = '<div class="globe-scrolly">'
        ...
        + '</div>';
      // Closing reminder: these are a few of the platform's many learners, worldwide.
      const geoClose = '<div class="geo-close rv"><p>Six stories from a global classroom — and counting. SURGhub now reaches <b class="num" data-to="' + D.learners + '">0</b> health workers across <b class="num" data-to="' + D.countries + '">0</b> countries around the world.</p></div>';
      ...
      const CSS = ':root{--prussian:#04263d;--prussian-deep:#021a2c;--boston:#2f86c9;--boston-soft:#7fb6e3;--green:#3FB984;--slate:#94a3b8;--red:#e57373;--ink:#0f2330;--paper:#f6f9fc;--paper2:#eef4f9;--line:rgba(255,255,255,.12)}'
        ...
        + '.geo-close{max-width:760px;margin:54px auto 0;text-align:center}.geo-close p{font-size:clamp(20px,2.6vw,28px);font-weight:700;line-height:1.45;color:#eaf2f8;margin:0}.geo-close b{font-weight:800;font-variant-numeric:tabular-nums}.geo-close b:first-of-type{color:var(--green)}.geo-close b:last-of-type{color:var(--boston-soft)}'
      ...
      return '<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">'
        ...
        + body
        + '<script>var D = ' + json + ';var LAND = ' + LANDJSON + ';(' + PAGE.toString() + ')();<\/script>'
        + '</body></html>';
    }
  };
