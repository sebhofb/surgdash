...
Object.assign(window.App, {
    ...
    // Physician-workforce reach moved to its own dashboard tab — see
    // js/physicianReach.js. The version that lived here classified doctors from the
    // canonical cadre, which merges nurse anaesthetists and anaesthesia technicians
    // into 'Anaesthesia' and counts all three as physicians, and grossed every country
    // up by one global factor. Both are fixed in the new module, so it is a rewrite
    // rather than a move.
